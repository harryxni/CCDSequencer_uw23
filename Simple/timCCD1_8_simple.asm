...
;PM (Dec 12, 2019): Shutter related routines have been removed from this version
;of the sequencer.

;PM (DEC 12, 2019): Clear CCD routine has been removed. Its not used.
...
;PM (Dec 13, 2019): Removed synthetic image generation. Not used.
